虽然 Vite 的插件机制是基于 Rollup 来设计的，但实际上 Vite 的插件机制也包含了自己独有的一部分，与 Rollup 的各个插件 Hook 并非完全兼容，将重点关注 Vite 独有的部分以及和 Rollup 所区别的部分，而对于 Vite 和 Rollup 中相同的 Hook (如`resolveId`、`load`、`transform`)只是稍微提及，就不再展开赘述了。
...
![image.png](https://qn.huat.xyz/mac/202402051638365.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051653120.awebp)

由此我们可以梳理出 Vite 插件的执行顺序:

![image.png](https://qn.huat.xyz/mac/202402051653728.awebp)
...
![plugin.png](https://qn.huat.xyz/mac/202402051656270.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051659588.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051700765.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051702618.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051702951.awebp)

你可以通过这个地址来查看项目中各个模块的编译结果：

![image.png](https://qn.huat.xyz/mac/202402051702825.awebp)

点击特定的文件后，你可以看到这个模块经过各个插件处理后的中间结果，如下图所示:

![image.png](https://qn.huat.xyz/mac/202402051702542.awebp)
