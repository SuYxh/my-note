...
// 对象实例
const person1 = new Person("dahuang");
console.log(person1); // Person {name: 'dahuang'}
```
...
console.log(person1.name, person2.name); // 'dahuang' 'dahuang'
```
...
// 对象实例
const person = new Person("dahuang");
