...
2.  **只能完成 GET 请求**：JSONP 的原理会要求浏览器端生成一个`script`元素，而`script`元素发出的请求只能是`get`请求
...
![image-20200421152122793](http://mdrs.yuanjin.tech/img/image-20200421152122793.png "image-20200421152122793")
...
![image-20200421162846480](http://mdrs.yuanjin.tech/img/image-20200421162846480.png "image-20200421162846480")
...
![image-20200421165913320](http://mdrs.yuanjin.tech/img/image-20200421165913320.png "image-20200421165913320")
