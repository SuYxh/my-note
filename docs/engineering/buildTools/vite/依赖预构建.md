...
![](https://qn.huat.xyz/mac/202402051501665.awebp)
...
![](https://qn.huat.xyz/mac/202402051501459.awebp)

我在应用代码中调用了`debounce`方法，这个方法会依赖很多工具函数，如下图所示:

![image.png](https://qn.huat.xyz/mac/202402051503391.awebp)
...
![](https://qn.huat.xyz/mac/202402051503797.awebp)

总之，依赖预构建主要做了两件事情：

1、将其他格式(如 UMD 和 CommonJS)的产物转换为 ESM 格式，使其在浏览器通过 `<script type="module"><script>`的方式正常加载。

> 使用 `vite-plugin-commonjs` 插件来将 CommonJS 格式的包转换为 ESM 格式。
...
![image.png](https://qn.huat.xyz/mac/202402051504863.awebp)

同时，在项目启动成功后，你可以在根目录下的`node_modules`中发现`.vite`目录，这就是预构建产物文件存放的目录，内容如下:

![image.png](https://qn.huat.xyz/mac/202402051505131.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051506454.awebp)
...
当然，entries 配置也支持 [glob 语法](https://link.juejin.cn/?target=https%3A%2F%2Fgithub.com%2Fmrmlnc%2Ffast-glob "https://github.com/mrmlnc/fast-glob")，非常灵活，如:
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/595857912ca34a2d8ad45086313209e5~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e72fecff62ec477686aeb539ee66aa4e~tplv-k3u1fbpfcp-jj-mark:3024:0:0:0:q75.awebp)
...
![image.png](https://qn.huat.xyz/mac/202402051510256.awebp)
